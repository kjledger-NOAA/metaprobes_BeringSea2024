...
depending on what ecosystem is used to filter, some taxa should be retained: 
"Ammodytes personatus", "Oncorhynchus kisutch", "Oncorhynchus nerka", "Oncorhynchus tshawytscha"

but using "Pacific Ocean" might be too inclusive?  
...
curated_taxonomy <- uncollapsed_taxonomy %>%
  mutate(species = ifelse(taxon == "Atheresthes evermanni", NA, species),
         taxon = ifelse(taxon == "Atheresthes evermanni", "Atheresthes", taxon), ##lump Atheresthes all together b/c few spp-level asv ids 
         taxonomic_level = ifelse(taxon == "Atheresthes evermanni", "genus", taxonomic_level), 
